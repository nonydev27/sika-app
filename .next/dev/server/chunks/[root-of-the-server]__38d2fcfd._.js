...
"[project]/app/api/statement/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const [{ data: profile }, { data: transactions }, { data: budgets }] = await Promise.all([
        ...
        supabase.from('transactions').select('*').eq('user_id', user.id).gte('date', from || '2000-01-01').lte('date', to || new Date().toISOString().split('T')[0]).order('date', {
            ascending: true
        }),
        supabase.from('budgets').select('*, budget_categories(*)').eq('user_id', user.id).order('created_at', {
            ascending: false
        }).limit(1)
    ]);
    ...
    const byCategory = tx.filter((t)=>t.type === 'expense').reduce((acc, t)=>{
    ...
    // HTML statement
    const periodLabel = from && to ? `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(from), 'MMMM d, yyyy')} – ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(to), 'MMMM d, yyyy')}` : 'All Time';
    const categoryRows = Object.entries(byCategory).sort((a, b)=>b[1] - a[1]).map(([cat, amt])=>`
      <tr>
        <td>${cat}</td>
    ...
    <tr>
      <td>${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(t.date), 'MMM d, yyyy')}</td>
...
<div class="page">
  ...
  <div class="header">
    ...
    <div class="header-right">
      ...
      <p>${periodLabel}</p>
      <p>Generated: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), 'MMMM d, yyyy')}</p>
    </div>
  </div>
...
//# sourceMappingURL=%5Broot-of-the-server%5D__38d2fcfd._.js.map