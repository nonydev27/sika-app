...
"[project]/app/api/ai/cache-status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data: cached } = await supabase.from('ai_insights_cache').select('cached_at').eq('user_id', user.id).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d24da5cd._.js.map